...
int Bank_Statement(int k) {
  cout << endl;
  cout << endl;
  cout << "Terminal         :Hatfield Plaza 2"
       << "\t\t\t\t"
       << "Terminal No:7464848" << endl;
  cout << "Date             :2020/08/06"
       << "\t\t\t\t"
       << "Time     :10:44:13" << endl;
  ...
  cout << "Date     Transaction         Reference       Amount      Balance"
       << endl;
  cout << "06082020 ATM withdrawal      Hatfield ATM    R2900.54    -R89.67"
       << endl;
  cout << "11082020 Deposit             Pta North ATM   R100.00     R"
       << 100 - 89.67 << endl;
  cout << "For 2020 Pricing & Benefits visit Bank.co.za from 1 january to get "
          "more Details "
       << endl;
  cout << endl;
  cout << "\t\t\t\t"
       << "End Of Statement" << endl;
  return 0;
}
